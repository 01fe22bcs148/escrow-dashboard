...
## 🚀 Features
- Email-based user login with validation
- Subscribe and unsubscribe to supported stock tickers
- Live stock price updates without page refresh
- Real-time communication using WebSockets
- Multiple users supported simultaneously with independent dashboards
- Publicly deployed and accessible from any location
